...
# my_resume["projects"].append({"title":"Women Entrepreneurs",
#                              "year":2022,
...
#     print(my_resume["academic_details"])
# 
# changes=(input("Do you want to add Projects?"))
# if changes=="no" or changes=="NO":
#     print("No changes Done")
# if changes=="yes" or changes=="Yes":
#     project_title=(input("Enter Your Project Title:"))
#     year=int(input("Enter year of your project Completion:"))
#     role=(input("Enter your role in the Project:"))

#     # a={}
#     # a["title"]=project_title
#     # a["year"]=year
#     # a["role"]=role
